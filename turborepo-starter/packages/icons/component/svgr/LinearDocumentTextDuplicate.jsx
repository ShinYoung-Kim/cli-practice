...
const SvgLinearDocumentTextDuplicate = (props) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeWidth={1.5}
      d="M13.5 3.92v4a.87.87 0 0 0 .87.88h4a.18.18 0 0 0 .12-.3L13.8 3.8a.17.17 0 0 0-.3.12M15.69 14.87h-4.38M13.94 12.25h-2.63"
    />
    <path
      stroke="#000D26"
      strokeLinecap="round"
...
export default SvgLinearDocumentTextDuplicate;
